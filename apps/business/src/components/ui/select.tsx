...
//   ({ options, className, placeholder = "Select an option", ...props }, ref) => (
//     <select
//       ref={ref}
//       className={cn(
//         "w-full h-[55px] rounded-md border border-gray5 bg-white px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary placeholder:text-gray5",
//         className
//       )}
//       {...props}
//     >
