      ...
      <div className="flex flex-col gap-8 w-full">
       ...
       {/* Top stats cards */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="flex flex-col items-start min-h-[100px] justify-center">
            {/* Icon and data (replace with actual data/icons) */}
            <div className="flex items-center gap-3">
              <div className="rounded-full bg-[#EDF3FE] w-8 h-8" />
              <div>
          ...
          <Card className="flex flex-col items-start min-h-[100px] justify-center">
            <div className="flex items-center gap-3">
              <div className="rounded-full bg-[#FEF6ED] w-8 h-8" />
              <div>
                <div className="text-lg font-bold">12.5K</div>
                <div className="text-xs text-gray-500">Customers</div>
                <div className="text-xs text-red-600 mt-1">12% ↑</div>
              </div>
            </div>
          </Card>
          <Card className="flex flex-col items-start min-h-[100px] justify-center">
            <div className="flex items-center gap-3">
              <div className="rounded-full bg-[#FDF3F5] w-8 h-8" />
              <div>
          ...
          <Card className="flex flex-col items-start min-h-[100px] justify-center">
            <div className="flex items-center gap-3">
              <div className="rounded-full bg-[#F3F4FE] w-8 h-8" />
              <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-8">
          <Card className="w-full min-h-[220px]">
            <div className="font-semibold text-base mb-1">Referral Engagement Graph</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="w-full min-h-[180px]">
            ...
            <div className="text-xs text-gray-500 mb-3">Users chart over time</div>
            {/* Placeholder */}
            <div className="bg-gray-100 h-24 rounded-lg" />
          </Card>
          <Card className="w-full min-h-[180px]">
            <div className="font-semibold text-base mb-1">Top Channels</div>
            <div className="text-xs text-gray-500 mb-3">Channels with the most referrals over time</div>
            {/* Placeholder */}
            <div className="bg-gray-100 h-24 rounded-lg" />
          </Card>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Card className="w-full min-h-[180px]">
            <div className="font-semibold text-base mb-1">Cash Flow in Numbers</div>
            {/* Placeholder */}
            <div className="bg-gray-100 h-24 rounded-lg" />
          </Card>
        </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
              ...
              <div className="flex gap-2 items-center mt-2 md:mt-0">
                ...
                />
                {/* Filters (placeholder) */}
                <button className="border border-gray-200 rounded-md px-3 py-2 text-sm bg-[#F7F9FB]">Filters</button>
                <a className="text-primary font-medium text-sm ml-2 cursor-pointer hover:underline">View All &rarr;</a>
              </div>
            </div>
            {/* Table */}
            <div className="overflow-x-auto">
              <table className="w-full mt-4 text-sm">
                ...
                <tbody>
                  {/* Example rows */}
                  {[
                    { type: "Referral", status: "Active", statusColor: "bg-green-500", tagColor: "bg-[#4C8AFF]" },
                    { type: "Loyalty", status: "Completed", statusColor: "bg-blue-500", tagColor: "bg-[#B96AFF]" },
                    { type: "Combo", status: "Scheduled", statusColor: "bg-red-500", tagColor: "bg-[#6AB0B9]" },
                    { type: "Referral", status: "Active", statusColor: "bg-green-500", tagColor: "bg-[#4C8AFF]" },
                    { type: "Referral", status: "Completed", statusColor: "bg-blue-500", tagColor: "bg-[#4C8AFF]" },
                    { type: "Loyalty", status: "Active", statusColor: "bg-green-500", tagColor: "bg-[#B96AFF]" },
                    { type: "Loyalty", status: "Active", statusColor: "bg-green-500", tagColor: "bg-[#B96AFF]" },
                  ].map((row, i) => (
                    <tr key={i} className="border-b last:border-0">
                      <td className="px-4 py-3">Pro Gain</td>
                      <td className="px-4 py-3">
                        <span className={`inline-block px-4 py-1 rounded-lg text-white text-xs font-semibold ${row.tagColor}`}>
                          {row.type}
                        </span>
                      </td>
                      ...
                      <td className="px-4 py-3">
                        <span className={`inline-block px-3 py-1 rounded-lg text-white text-xs font-semibold ${row.statusColor}`}>
                          {row.status}
                        </span>
                      </td>
